...
class Config:
    """Configuration class for setting up available languages and default settings."""
    LANGUAGES = ["en", "fr"]
...
def index():
    ...
    return render_template('1-index.html', title=_("home_title"), header=_("home_header"))
